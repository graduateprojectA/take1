...
public interface UserTimetableRepository extends JpaRepository<User_timetable, Integer> {
    @Query(value="SELECT user_timetable_no FROM user_timetable s where s.user_no =:user_no and " +
            "s.class_1 =:class_1 and s.class_2 =:class_2 and s.class_3 =:class_3 and s.class_4 =:class_4 " +
            "and s.class5 =:class_5 and s.class_6 =:class_6 and s.class_7 =:class_7 and s.class_8 =:class_8 " +
